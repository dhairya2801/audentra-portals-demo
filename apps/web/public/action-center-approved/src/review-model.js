...
export function fieldSchema(t) {
 ...
 const name=row('name','Full name',flag('name')?(t.hero?'Maya Patel':t.student.split(' ')[0]+' '+t.student.split(' ').at(-1)[0]+'.'):(t.hero?'Maya Anika Patel':t.student),t.hero?'Maya Anika Patel':t.student,'ENR-02 · Legal identity',{number:1,reason:'Name differs from the application. Compare date of birth and institution before accepting the variation.'});
